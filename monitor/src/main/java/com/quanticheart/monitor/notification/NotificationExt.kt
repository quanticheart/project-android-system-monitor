...
package com.quanticheart.monitor.notification
...
import com.quanticheart.monitor.notification.ResourcesHelper.getStringResourceByKey
...
private fun notificationID() = AtomicInteger(0).incrementAndGet()
