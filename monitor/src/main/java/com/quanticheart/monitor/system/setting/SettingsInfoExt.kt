package com.quanticheart.monitor.system.setting
...
internal fun Context.getSettingsDetails(): com.quanticheart.monitor.system.setting.Settings {
    val settingsBean = com.quanticheart.monitor.system.setting.Settings()
    try {
